...
// TODO
- defer - функция котокрая вызовется после завершения метода, удобно для закрытия файла, канала и тд
