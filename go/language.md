...
- если этачить метод к указателю на структуру то изменения внутри метода видны снружи. Если этачить к структуре то изменения не применятся (сетер не будет работать)
